...
| [0018](0018-fronteira-http-erro-traduzido-e-autenticacao-obrigatoria.md) | Fronteira HTTP traduz erro; nenhuma rota de negócio sem autenticação | Aceito |
| [0019](0019-dinheiro-como-texto-inteiro-no-json.md) | Dinheiro e quantidade como texto inteiro no JSON | Aceito |
